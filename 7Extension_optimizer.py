...
# --- 2. 训练函数  ---
def train_single_model(model_name, train_loader, test_loader, device, num_epochs, fixed_seed, optimizer):
    """
...
epochs = 50
optimizer_setting = [optim.SGD, optim.RMSprop, optim.Adam]
results = []

# === 循环不同的 Epoch 设置 ===
for opt in optimizer_setting:
    opt_name = opt.__name__
    model_name = f"MyModel_optim_{opt_name}"
